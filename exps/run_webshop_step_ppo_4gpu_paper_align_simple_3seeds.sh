...
BASE_EXPERIMENT="step_ppo_qwen2.5_1.5b_4gpu_paper_align_full_e250"
...
cd "$ROOT_DIR"
echo "[ENV] Step-PPO batch target: H100 (sm_90)"
...
echo "[DONE] All Step-PPO seed runs finished: ${SEEDS[*]}"
