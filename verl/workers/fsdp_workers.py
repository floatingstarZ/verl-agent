...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        actor_model_config = AutoConfig.from_pretrained(local_path, trust_remote_code=trust_remote_code, attn_implementation=self.config.model.get("attn_implementation", "flash_attention_2"))
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        critic_model_config = AutoConfig.from_pretrained(local_path, attn_implementation=config.model.get("attn_implementation", "flash_attention_2"), trust_remote_code=config.model.get("trust_remote_code", False))
