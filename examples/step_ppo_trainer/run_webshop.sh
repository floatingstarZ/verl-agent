...
"$PYTHON_BIN" -m verl.trainer.main_step_ppo \
    ...
    algorithm.step_ppo.step_advantage_w=$step_advantage_w \
    algorithm.step_ppo.step_gamma=0.95 \
    algorithm.step_ppo.step_lam=1.0 \
    algorithm.step_ppo.normalize_episode_advantage=True \
    ...
    trainer.experiment_name='step_ppo_qwen2.5_1.5b' \
