...
from istar.rm_utils import compute_dpo_abs_accuracy, compute_dpo_accuracy
...
class ISTARRewardModelWorker(Worker):
    ...
    def _build_reward_ref_model_optimizer(self, config):
        ...
        with init_context(), warnings.catch_warnings():
            ...
            reward_module = AutoModelForCausalLM.from_pretrained(
                ...
                attn_implementation=os.getenv("VERL_ATTN_IMPLEMENTATION", "flash_attention_2"),
        ...
        with init_context(), warnings.catch_warnings():
            ...
            reward_model_config.classifier_dropout = 0.0
            reward_model_config.hidden_dropout = "0"
            if self.config.model.ref_path is not None:
    ...
    def init_model(self):
        ...
        from istar.dp_rm import DataParallelISTARRewardModel
    ...
    def compute_rm_score(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            dpo_acc = compute_dpo_accuracy(rm_scores, acc, response_mask=response_mask, n_samples=self.config.num_rollout)
    ...
    def update_rm_eto(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            rm_scores, metrics = self.rm.update_rm_eto(data=data)
