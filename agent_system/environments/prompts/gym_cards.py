...
GYM_CARDS_NUMBERLINE_TEXT_TEMPLATE = """
You are playing a game called number line. Your goal is to move the current number closer to the target number by choosing either subtracting one or adding one to the current number.
...
"current number": "x",
"target number": "x",
"thoughts": "compare the current and target number, then choose the action that moves current closer to target",
"action": "-" or "+"
}}
"""
